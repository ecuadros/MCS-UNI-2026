...
using Area2d = double;
using Volumen = double;//Defincion volumen -- Jhon Tellez
...
public:
  ...
  virtual Volumen GetVolumen() const = 0; // Método virtual puro
...
// Agregar método virtual para imprimir información específica del volumen -- Jhon Tellez
  virtual void Print(ostream &os) const {
    os << "Nombre: " << GetClassName() << " | Volumen: " << GetVolumen()
       << " | Test: ";
    Test(os);
  };
